...
public:
  ...
  bool FillPointCloudHelper(std::string camera_id, sensor_msgs::PointCloud2 &point_cloud_msg, uint32_t rows_arg,
...
protected:
  ...
  std::map<std::string, sensor_msgs::Image> image_map_;
};
}
