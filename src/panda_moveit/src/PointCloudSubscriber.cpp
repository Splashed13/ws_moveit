#include "../include/panda_moveit/PointCloudSubscriber.hpp"

PointCloudSubscriber::PointCloudSubscriber() : nh("pc")
{
    point_cloud_sub_ = nh.subscribe("/D435_camera1/depth/color/points", 1, &PointCloudSubscriber::pointCloudCallback, this);
    saved = false;
...
int main(int argc, char** argv)
{
    ...
    PointCloudSubscriber point_cloud_subscriber;
